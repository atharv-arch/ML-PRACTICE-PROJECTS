 ...
 *
 * The API_BASE is auto-detected:
 *   - Web mode: uses relative '/api' (same-origin FastAPI server)
 *   - Mobile (Capacitor): uses the configured BACKEND_URL
 */

// ── Backend URL Configuration ─────────────────────────────────────
// For mobile deployment, set this to your deployed backend URL.
// Examples: 'https://your-app.onrender.com', 'https://your-api.vercel.app'
const BACKEND_URL = window.APP_CONFIG?.backendUrl || '';

// Auto-detect: if running inside Capacitor native shell, use full URL
